...
in
  linkFarm name [
    ...
    {
      name = "ghostty-1.3.2-dev-5UdBCyXBUgVq7uJjVAyUaZJ1kHRCPIhfg8SnptGRwnn1";
      path = fetchZigArtifact {
        name = "ghostty";
        url = "git+https://github.com/ghostty-org/ghostty.git#8144ef4e73e70a4e9942fceb319819005f07fd37";
        hash = "sha256-b5bDZw9spMLuY9XnUH65HWCaXVUKFhzRzHW0cgglVZI=";
        unpack = true;
      };
    }
    {
      name = "wayland-0.7.0-dev-lQa1kjT8AQDBstL61Gy3WCMtGwVaMN1p6w5wGfdDvP15";
      path = fetchZigArtifact {
        name = "wayland";
        url = "git+https://codeberg.org/ifreund/zig-wayland#a8e10e87e5ebb49ce518ac3d2198909c87ee615a";
        hash = "sha256-QZDZwUngM9Tb85ZhAW/fbKzXg09c1TYZCGWlg3KShBo=";
        unpack = true;
      };
    }
    {
      name = "z2d-0.12.2-pre-j5P_HtA8EQDpzu5RUtQhr_Sn9MeQF3_q7rWMw3ouesd0";
      path = fetchZigArtifact {
        name = "z2d";
        url = "git+https://github.com/vancluever/z2d#47fc1030c1636dcfb75ea1cc238f706dd1feb379";
        hash = "sha256-KBtakus3/aKXBl31lxmKUkfHdr6QCDbUkOeeZw7usBo=";
        unpack = true;
      };
    }
    {
